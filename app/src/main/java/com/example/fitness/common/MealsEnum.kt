...
enum class MealsCategoriesForNatural(val mealsId: String,
    ...
    fivawdwae(mealsId = "", imageRes = R.drawable.chicken_caldereta_dinner , mealsName = "", mealsDescription = "", mealTime =MealTime.DINNER.label , calories =" ", protein ="55" , carbs = "5", fats = "65"),
    siawdx(mealsId = "", imageRes = R.drawable.bangus_belly_sinigang_dinner , mealsName = "Bangus Belly", mealsDescription = "", mealTime =MealTime.DINNER.label , calories ="25", protein ="54" , carbs = "45", fats = "45"),
    sewadven(mealsId = "", imageRes = R.drawable.grilled_bangus_dinner , mealsName = "Grilled Bangus", mealsDescription = "", mealTime =MealTime.DINNER.label , calories ="55", protein ="56" , carbs = "65", fats = "45"),
    eiwdght(mealsId = "", imageRes = R.drawable.grilled_tilapia_w_spinach_dinner , mealsName = "Grilled Tilapia", mealsDescription = "", mealTime =MealTime.DINNER.label, calories ="56", protein ="65" , carbs = "56", fats = ""),
    niawdne(mealsId = "", imageRes = R.drawable.pork_binagoongan_dinner , mealsName = "Pork Binagoongan", mealsDescription = "", mealTime =MealTime.DINNER.label , calories ="45", protein ="34" , carbs = "34", fats = "34"),
    teawdn(mealsId = "", imageRes = R.drawable.chicken_tocino_dinner , mealsName = "Chicken Tocino", mealsDescription = "", mealTime =MealTime.DINNER.label , calories ="44", protein ="34" , carbs = "34", fats = "34"),
    elawdeven(mealsId = "", imageRes = R.drawable.tuna_omellete_with_mango_dinner , mealsName = "Tuna Omelette", mealsDescription = "", mealTime =MealTime.DINNER.label, calories ="23", protein ="34" , carbs = "34", fats = "34"),
    twawdelve(mealsId = "", imageRes = R.drawable.pandesal_with_peanut_and_papaya_dinner , mealsName = "Bread with Peanut butter", mealsDescription = "", mealTime =MealTime.DINNER.label , calories ="34", protein ="34" , carbs = "34", fats = "34"),
    thiawdrteen(mealsId = "", imageRes = R.drawable.tuna_pandesal_dinner , mealsName = "Tuna Pandesal", mealsDescription = "", mealTime =MealTime.DINNER.label , calories ="53", protein ="23" , carbs = "", fats = "54"),
    fouadwadrteen(mealsId = "", imageRes = R.drawable.pork_nilaga_with_cucumber_dinner , mealsName = "Pork with cucumber", mealsDescription = "", mealTime =MealTime.DINNER.label , calories ="5", protein ="" , carbs = "52", fats = "23"),
    fivwdeteen(mealsId = "", imageRes = R.drawable.tuna__dinner , mealsName = "", mealsDescription = "Tuna with Rice", mealTime =MealTime.DINNER.label , calories ="22", protein ="12" , carbs = "54", fats = "23"),
